  ...
  return (
    ...
    >
          ...
          {titles.map((title, index) => (
            <div key={title + index} className="h-screen pt-10 my-20">
              ...
              {index === 0 && <motion.p
                ...
                className="mt-10 text-4xl text-slate-300"
              >
              ...
              {index === 2 && <motion.div initial={{
                ...
                className="mt-10 text-3xl text-slate-300"
              >
      ...
      <motion.div animate={{
        ...
        className="sticky overflow-y-hidden hidden h-[45vh] bg-white rounded-md lg:block w-[32vw] top-56 shadow-lg"
      >
        <div className="relative w-full h-full">
          <motion.div
            className="absolute inset-0 flex flex-col gap-1 p-4 text-[5.7rem] leading-none"
            initial={{
              opacity: 0,
            }}
            animate={{
          ...
          <motion.div
            className="absolute inset-0 flex flex-col w-full h-full gap-2 p-4"
            initial={{
              opacity: 0,
            }}
            animate={{
          ...
          >
            <div className="relative w-full h-[90%] drop-shadow-2xl">
              <Image
                src="/poster.png"
                alt="projects"
                fill
          ...
          >
            <p className="text-2xl font-semibold">Scan for my contact info</p>
