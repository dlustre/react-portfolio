...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Programming Languages}{: TypeScript/JavaScript, Rust, C, C++, Java, SQL, HTML, CSS/Tailwind CSS} \\
    \textbf{Tech}{: React.js, Node.js, ORM, MySQL, Postman, Cypress, AWS, Azure, Vercel, NoSQL, CUDA, NumPy} \\
    \textbf{Other}{: GitLab, Scrum, Jira/Kanban, Linux, Jupyter, Bash/Powershell, Shell Scripting} \\
    }}
  \end{itemize}
