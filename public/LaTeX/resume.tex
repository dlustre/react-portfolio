...
\section{Experience}
  ...
  \resumeItemListStart
  \resumeItem{\textbf{Led frontend development} by designing \textbf{Figma} mockups, creating \textbf{React Native} components, and integrating with the backend using \textbf{TRPC}}
    \resumeItem{\textbf{Sped up daily and weekly backend services by 50\%} by parallelizing async operations for all \textbf{AWS Lambda} functions}
...
\section{Projects}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Won 2 awards at Data@UCI's Atlantis Datathon 2024:} \textbf{People's Choice} and \textbf{Best Use of Melissa API or Data Sets}}
...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Tech}{: React.js, React Native, Next.js, Node.js, ORM, Docker, Postman, Cypress, AWS, Azure, Vercel, Firebase} \\
    \textbf{Other}{: GitHub/GitLab, Agile (Scrum), Jira (Kanban), GitHub Actions, Linux, Jupyter, DigitalOcean, Bash/Powershell} \\
    }}
  \end{itemize}
