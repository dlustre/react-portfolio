  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textbf{Reduced DevOps manual intervention by 100\%} by creating a \textbf{CI/CD} pipeline with \textbf{GitHub Actions} workflows and \textbf{Docker}. Further optimized the pipeline by parallelizing \textbf{Jest} and \textbf{Cypress} test suites and caching build and test dependencies}
      ...
      \resumeItemListStart
      \resumeItem{\textbf{Streamlined full-stack development and reduced maintenance overhead} by overhauling the monorepo to use \textbf{T3 Stack (TypeScript, Prisma, tRPC)}, \textbf{AWS Lambda}, and \textbf{Turborepo}}
