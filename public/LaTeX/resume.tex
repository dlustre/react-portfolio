...
\section{Experience}
  ...
  \resumeItemListStart
  \resumeItem{\textbf{Streamlined full-stack development, increased scalability, and reduced maintenance overhead} by restructuring the monorepo to use \textbf{Turborepo}, \textbf{AWS Lambda}, and \textbf{T3 Stack (TypeScript, Prisma, tRPC)}}
