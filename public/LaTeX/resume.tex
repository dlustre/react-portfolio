...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{\textbf{Courses}: Computer Vision, Machine Learning, Artificial Intelligence, Data Structures \& Algorithms, System Design}
...
\section{Experience}
  ...
  \resumeItemListStart
    ...
    \resumeItem{\textbf{Sped up daily and weekly back-end microservices by 50\%} by parallelizing async operations for all \textbf{AWS Lambda} functions}
...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Programming Languages}{: TypeScript/JavaScript, Golang, Rust, C, C++, Java, SQL, HTML, CSS/Tailwind CSS} \\
    \textbf{Tech}{: React.js, Node.js, ORM, MySQL, Postman, Cypress, AWS, Azure, Vercel, NoSQL, CUDA, NumPy} \\
    \textbf{Other}{: GitLab, Scrum, Jira/Kanban, Linux, Jupyter, Bash, Powershell, Shell Scripting, HTTP, TCP, SDLC} \\
    }}
  \end{itemize}
