...
\begin{center}
    ...
    \faLinkedinSquare{ }\href{https://linkedin.com/in/dlustre}{\uline{dlustre}} $|$
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{\textbf{Leadership \& Involvement}: Software Sub-Team Lead \& Mentor for FUSION $|$ ICS Student Council Projects Committee}
...
\section{Experience}
  ...
  \resumeItemListStart
    \resumeItem{\textbf{Led front-end development} by designing \textbf{Figma} mockups, creating Android and iOS compatible \textbf{React Native} components, and integrating with the back-end using \textbf{TRPC}}
    \resumeItem{\textbf{Sped up daily and weekly back-end services by 50\%} by parallelizing async operations for all \textbf{AWS Lambda} functions}
    ...
    \resumeItem{\textbf{Built an events listing feature front-to-back} by utilizing \textbf{Cheerio} and \textbf{Axios} to scrape dining hall event data and display it on the app}
  \resumeItemListEnd

  \resumeSubheading
  {Software Lead}{November 2023 - Present}
  {FUSION Engineering Project}{Irvine, CA}
  \resumeItemListStart
    \resumeItem{\textbf{Led the development of embedded systems software within a cross-functional team of 11 engineers} for a gesture-controlled robotic arm}
    ...
    \resumeItem{\textbf{Designed a robust serial communication protocol over Bluetooth} between \textbf{Arduino} microcontrollers, enabling robot arm movements using flex sensors and servo motors}
  \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Won 2 awards at Data@UCI's Atlantis Datathon:} \textbf{People's Choice} and \textbf{Best Use of Melissa API or Data Sets}}
...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Programming Languages}{: TypeScript/JavaScript, Rust, C/C++, Python, SQL, HTML, CSS/Tailwind CSS} \\
    \textbf{Tech}{: React.js, React Native, Next.js, Node.js, ORM, MySQL, Postman, Cypress, AWS, Azure, Vercel, Firebase} \\
    \textbf{Other}{: GitLab, Scrum, Jira/Kanban, Data Structures, Algorithms, Linux, Jupyter, Bash/Powershell, Shell Scripting} \\
    }}
  \end{itemize}
