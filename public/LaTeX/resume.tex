...
\section{Projects}
    ...
    \resumeProjectHeading
      {\textbf{Gesture-Controlled Robot Arm} $|$ \emph{Arduino} $|$ \href{https://github.com/KamayGuys/KamayGuy}{\uline{GitHub}}}{}
...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Tech}{: React.js, Node.js, ASP.NET, MySQL, Postman, Cypress, AWS, Azure, Vercel, NoSQL, CUDA, NumPy, pandas} \\
